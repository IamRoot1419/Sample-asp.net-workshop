<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CustomerEdits.aspx.cs" Inherits="workshop101.CustomerEdits" %>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList runat="server" ID="dll" CssClass="form-control">
                                <asp:ListItem Text="test1"></asp:ListItem>
                                <asp:ListItem Text="test2"></asp:ListItem>
                            </asp:DropDownList>
                        </div>
                        <div class="form-group">
                            <asp:Label Text="Date&Time" Font-Bold="true" runat="server"></asp:Label>
